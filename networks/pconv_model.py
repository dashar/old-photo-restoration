...
class PConvUnet(object):
    ...
    def __init__(self, img_rows=IMG_SIZE, img_cols=IMG_SIZE, weight_filepath=None, vgg_weights="imagenet", inference_only=False):
    ...
    def build_pconv_unet(self, train_bn=True, lr=0.0002):      
        ...
        e_conv4, e_mask4 = encoder_layer(e_conv3, e_mask3, IMG_SIZE, 3)
        e_conv5, e_mask5 = encoder_layer(e_conv4, e_mask4, IMG_SIZE, 3)
        e_conv6, e_mask6 = encoder_layer(e_conv5, e_mask5, IMG_SIZE, 3)
        e_conv7, e_mask7 = encoder_layer(e_conv6, e_mask6, IMG_SIZE, 3)
        e_conv8, e_mask8 = encoder_layer(e_conv7, e_mask7, IMG_SIZE, 3)
    ...
    def get_chunks(self, img):
        ...
        x_chunks, y_chunks = [(0, IMG_SIZE)], [(0, IMG_SIZE)]        
